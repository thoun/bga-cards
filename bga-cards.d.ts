...
declare class CardStock<T> {
     ...
     */
    addCards(cards: T[], animation?: CardAnimationSettings, settings?: AddCardSettings, shift?: number | boolean): Promise<boolean>;
    /**
...
declare class Deck<T> extends CardStock<T> {
    ...
    addCard(card: T, animation?: CardAnimationSettings, settings?: AddCardToDeckSettings): Promise<boolean>;
...
declare class VoidStock<T> extends CardStock<T> {
     ...
     * @returns the promise when the animation is done (true if it was animated, false if it wasn't)
     */
    addCard(card: T, animation?: CardAnimationSettings, settings?: AddCardToVoidStockSettings): Promise<boolean>;
}
