...
function initManualPositionDiagonalStock() {
    manualPositionDiagonalStock = new BgaCards.ManualPositionStock(cardsManager, document.getElementById('manual-position-diagonal-stock'), undefined, manualPositionDiagonalUpdateDisplay);
...
function initManualPositionCurveStock() {
    ...
    manualPositionCurveStock = new BgaCards.ManualPositionStock(cardsManager, document.getElementById('manual-position-curve-stock'), undefined, manualPositionCurveUpdateDisplay);
...
function initManualPositionFitStock() {
    manualPositionFitStock = new BgaCards.ManualPositionStock(cardsManager, document.getElementById('manual-position-fit-stock'), undefined, manualPositionFitUpdateDisplay);
